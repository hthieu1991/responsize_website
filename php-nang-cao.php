<?php $title = 'Các bài viết về PHP nâng cao, Advanced PHP Programing, dành cho những người đã có kiến thức PHP cơ bản'; 
	  $short_content = 'Tổng hợp các bài viết về PHP nâng cao, chuyên sâu dành cho người đã có kiến thức cơ bản về PHP';
?>
<?php include 'inc/top.php';?>
    <div class="row">
		
        <div class="col-sm-9">
        	<h3 align="center" class="jumbotron h-about">Hướng dẫn lập trình PHP nâng cao</h3>
			    ...
			    <table class="table">
			      ...
			      <tbody>
			      	<?php
				          ...
				          $sql = "SELECT * FROM thread WHERE cat_id=2 ORDER BY upd_date DESC";
